...
changeColor = (color) => {
  Db4Key.style.background = color;
  Eb4Key.style.background = color;
  Gb4Key.style.background = color;
  Ab4Key.style.background = color;
  Bb4Key.style.background = color;
  Db5Key.style.background = color;
  Eb5Key.style.background = color;
}
